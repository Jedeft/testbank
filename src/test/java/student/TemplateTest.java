...
public class TemplateTest {
	...
	public void insertTest() throws Exception{
		...
		mockMvc.perform(post("/student/templates").session(mockSession)
	...
	public void updateTest() throws Exception{
		...
		mockSession.setAttribute("currentUser", user);
		TemplateParams template = new TemplateParams();
		template.setTemplate_id(145983588652901L);
		template.setCourse_id("1");
		...
		mockMvc.perform(patch("/student/templates")
											   .session(mockSession)
											   .contentType(MediaType.APPLICATION_JSON)
											   .content(JSONUtils.convertObject2Json(template))
											   .characterEncoding(CharEncoding.UTF_8)
	...
	public void searchTest() throws Exception{
		mockMvc.perform(get("/student/templates?course_id=1").contentType(MediaType.TEXT_HTML)
											   .characterEncoding(CharEncoding.UTF_8)
											   .accept(MediaType.APPLICATION_JSON)
											   .characterEncoding(CharEncoding.UTF_8))
	...
	public void getTest() throws Exception{
		mockMvc.perform(get("/teacher/templates/{template_id}", 145983588652901L).contentType(MediaType.TEXT_HTML)
											   .characterEncoding(CharEncoding.UTF_8)
											   .accept(MediaType.APPLICATION_JSON)
											   .characterEncoding(CharEncoding.UTF_8))
										  .andExpect(status().isOk())
