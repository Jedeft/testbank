...
public class TeacherTest {
	...
	/**
	 * url : /admin/teachers method : POST
	 * 
	 * @throws Exception
	 */
	@Test
	public void insertTest() throws Exception {
		...
		mockMvc.perform(
				post("/admin/teachers").contentType(MediaType.APPLICATION_JSON)
	...
	/**
	 * url : /admin/teachers method : PATCH
	 * 
	 * @throws Exception
	 */
	@Test
	...
	/**
	 * url : /admin/teachers/{teacher_id} method : GET
	 * 
	 * @throws Exception
	 */
	@Test
	public void selectOneTest() throws Exception {
		mockMvc.perform(
				get("/admin/teachers/{teacher_id}", 123)
	...
	/**
	 * url : /admin/teachers/{teacher_id} method : DELETE
	 * 
	 * @throws Exception
	 */
	@Test
	public void deleteTest() throws Exception {
		mockMvc.perform(
				delete("/admin/teachers/{teacher_id}", "test")
						.contentType(MediaType.TEXT_HTML)
						.characterEncoding(CharEncoding.UTF_8)
						.accept(MediaType.APPLICATION_JSON)
						.characterEncoding(CharEncoding.UTF_8))
	...
	/**
	 * url : /admin/teachers/batch method : DELETE
	 * 
	 * @throws Exception
	 */
	@Test
	...
	/**
	 * url : /admin/teachers/csv params : file method : POST
	 * 
	 * @throws Exception
	 */
	@Test
	...
	/**
	 * url : /admin/teachers params : page=1 , rows=15 : teacher_id, academy_id,
	 * name method : GET
	 * 
	 * @throws Exception
	 */
	...
	public void searchTest() throws Exception {
		mockMvc.perform(
				get("/admin/teachers/?page=1&rows=15")
						.contentType(MediaType.TEXT_HTML)
						.characterEncoding(CharEncoding.UTF_8)
						.accept(MediaType.APPLICATION_JSON)
						.characterEncoding(CharEncoding.UTF_8))
