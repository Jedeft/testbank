...
public class SyllabusTest {
	...
	/**
	 * url : /admin/syllabuses method : POST
	 * 
	 * @throws Exception
	 */
	@Test
	...
	/**
	 * url : /admin/syllabuses method : PATCH
	 * 
	 * @throws Exception
	 */
	@Test
	...
	/**
	 * url : /admin/syllabuses/{syllabuses_id} method : GET
	 * 
	 * @throws Exception
	 */
	@Test
	public void selectOneTest() throws Exception {
		mockMvc.perform(
				get("/admin/syllabuses/{syllabuses_id}", "144966941493001")
	...
	/**
	 * url : /admin/syllabuses/{syllabus_id} method : DELETE
	 * 
	 * @throws Exception
	 */
	@Test
	public void deleteTest() throws Exception {
		mockMvc.perform(
				delete("/admin/syllabuses/{syllabus_id}", "144966941493001")
						.contentType(MediaType.TEXT_HTML)
						.characterEncoding(CharEncoding.UTF_8)
						.accept(MediaType.APPLICATION_JSON)
						.characterEncoding(CharEncoding.UTF_8))
	...
	/**
	 * url : /admin/syllabuses/batch method : DELETE
	 * 
	 * @throws Exception
	 */
	@Test
	...
	/**
	 * url : /admin/syllabuses/csv params : file csv文件不用包含syllabus_id method :
	 * POST
	 * 
	 * @throws Exception
	 */
	...
	public void loadCsvTest() throws Exception {
		...
		MockMultipartFile mokeFile = new MockMultipartFile("file",
				"syllabuses.csv", null, in);
		mockMvc.perform(fileUpload("/admin/syllabuses/csv").file(mokeFile))
				.andDo(print());
	}

	/**
	 * url : /admin/syllabuses params : page=1 , rows=15 : start, end method :
	 * GET
	 * 
	 * @throws Exception
	 */
	...
	public void searchTest() throws Exception {
		mockMvc.perform(
				get("/admin/syllabuses/?page=1&rows=15")
						.contentType(MediaType.TEXT_HTML)
						.characterEncoding(CharEncoding.UTF_8)
						.accept(MediaType.APPLICATION_JSON)
						.characterEncoding(CharEncoding.UTF_8))
