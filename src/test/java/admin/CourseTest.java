...
public class CourseTest {
	...
	public void insertTest() throws Exception {
		...
		mockMvc.perform(
				post("/admin/courses").contentType(MediaType.APPLICATION_JSON)
	...
	/**
	 * url : /admin/courses method : PATCH
	 * 
	 * @throws Exception
	 */
	@Test
	public void updateTest() throws Exception {
		...
		mockMvc.perform(
				patch("/admin/courses").contentType(MediaType.APPLICATION_JSON)
						.content(requestBody.toString())
						.characterEncoding(CharEncoding.UTF_8)
						.accept(MediaType.APPLICATION_JSON)
						.characterEncoding(CharEncoding.UTF_8))
	...
	/**
	 * url : /admin/courses/{course_id} method : GET
	 * 
	 * @throws Exception
	 */
	@Test
	...
	/**
	 * url : /admin/courses/{course_id} method : DELETE
	 * 
	 * @throws Exception
	 */
	@Test
	public void deleteTest() throws Exception {
		mockMvc.perform(
				delete("/admin/courses/{course_id}", 1)
						.contentType(MediaType.TEXT_HTML)
						.characterEncoding(CharEncoding.UTF_8)
						.accept(MediaType.APPLICATION_JSON)
						.characterEncoding(CharEncoding.UTF_8))
	...
	/**
	 * url : /admin/courses/batch method : DELETE
	 * 
	 * @throws Exception
	 */
	@Test
	...
	/**
	 * url : /admin/courses/csv params : file method : POST
	 * 
	 * @throws Exception
	 */
	@Test
	public void loadCsvTest() throws Exception {
		...
		MockMultipartFile mokeFile = new MockMultipartFile("file",
				"courses.csv", null, in);
		mockMvc.perform(fileUpload("/admin/courses/csv").file(mokeFile)).andDo(
				print());
	}

	/**
	 * url : /admin/courses params : page=1 , rows=15 : course_id, major_id,
	 * name method : GET
	 * 
	 * @throws Exception
	 */
	...
	public void searchTest() throws Exception {
		mockMvc.perform(
				get("/admin/majors/?page=1&rows=15")
						.contentType(MediaType.TEXT_HTML)
						.characterEncoding(CharEncoding.UTF_8)
						.accept(MediaType.APPLICATION_JSON)
						.characterEncoding(CharEncoding.UTF_8))
