...
public class TemplateController {
	...
	@ApiOperation(value = "添加考试模板", httpMethod = "POST", response = ResponseMsg.class, notes = "需要baseTeacher权限，请header中携带Token")
	public ResponseMsg insertStudents(
			@ApiParam(required = true, name = "template", value = "添加的考试模板json数据，ID为后台自生成，前台校验三个ratio比例加起来为100%") @RequestBody TemplateParams template,
	...
	@ApiOperation(value = "修改考试模板", httpMethod = "PATCH", response = ResponseMsg.class, notes = "需要baseTeacher权限，请header中携带Token")
	...
	@ApiOperation(value = "获取模板", httpMethod = "GET", response = ResponseMsg.class, notes = "需要baseTeacher权限，请header中携带Token")
